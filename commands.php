...
if(isset($text))
{
	...
	{
		sendMessage($chat_id, '/help - Show this message' . PHP_EOL . '/license - Sends you the link of the page with the license and source code of the bot');
	}
